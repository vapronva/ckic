...
func parseFlags() options {
	...
	pflag.BoolVar(&cfg.ExternalPublishAggregated, "external-publish-aggregated", true, "Publish aggregated Caddyfile to a mirror ConfigMap")
	pflag.StringVar(&cfg.ExternalAggregatedConfigName, "external-aggregated-config-name", "ckic-caddy-config-working", "Name of the mirror ConfigMap for aggregated config")
